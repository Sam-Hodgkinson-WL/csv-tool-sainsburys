...
echo 'You can now close this window, if you close the browser tab with the tool you will be able to get back to it by going to http://localhost:3000 again'
